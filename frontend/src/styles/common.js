...
export const cardClass =
  "bg-[#f5f5f7] rounded-xl p-6 border border-transparent hover:border-[#e0e0e5] transition-all hover:shadow-sm";
...
export const primaryBtn =
  "bg-[#0066cc] text-white font-semibold px-6 py-2.5 rounded-full hover:bg-[#004499] transition-all cursor-pointer text-sm tracking-tight shadow-sm hover:shadow-md";
export const secondaryBtn =
  "border border-[#d2d2d7] text-[#1d1d1f] font-medium px-6 py-2.5 rounded-full hover:bg-[#f5f5f7] hover:border-[#ccc] transition-all cursor-pointer text-sm";
export const ghostBtn = "text-[#0066cc] font-medium hover:text-[#004499] hover:underline transition-all cursor-pointer text-sm";

// ─── Forms ────────────────────────────────────────────
export const formCard = "bg-[#f5f5f7] rounded-xl p-8 max-w-4xl mx-auto border border-[#e8e8ed]";
...
export const inputClass =
  "w-full bg-white border border-[#d2d2d7] rounded-lg px-4 py-2.5 text-[#1d1d1f] text-sm placeholder:text-[#a1a1a6] focus:outline-none focus:border-[#0066cc] focus:ring-2 focus:ring-[#0066cc]/10 transition-all";
export const formGroup = "mb-4";
export const submitBtn =
  "w-full bg-[#0066cc] text-white font-semibold py-2.5 rounded-full hover:bg-[#004499] transition-all cursor-pointer mt-3 text-sm tracking-tight shadow-sm hover:shadow-md";

// ─── Navbar ───────────────────────────────────────────
export const navbarClass =
  "bg-white/90 backdrop-blur-lg backdrop-saturate-150 border-b border-[#e8e8ed] px-6 h-14 flex items-center sticky top-0 z-50 shadow-sm";
...
export const articleCardClass =
  "bg-[#f5f5f7] p-6 hover:bg-[#ebebf0] transition-all duration-200 flex flex-col gap-2.5 cursor-pointer border border-transparent hover:border-[#e0e0e5]";
